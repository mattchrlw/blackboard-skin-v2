...
(function() {
    ...
    Array.prototype.forEach.call(courses, function(course) {
        ...
        if (courseCode != null) {
            ...
            course.firstChild.innerHTML = '<table style="font-size:13px; font-family: \'SF Pro Text\'"><tr><td style="width: 120px"><b>'+courseCode[1]+'</b></td><td style="width: 450px">' + courseName + "</td></tr></table>"
